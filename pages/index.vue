<template>
  <div class="lg:p-40 p-10 h-screen flex">
    <div class="flex-col gap-6 flex ">
      ...
      <h2
        v-motion class="text-3xl text-subtext1 " :initial=" {
          y: 100,
          opacity: 0,
        } " :enter=" {
          y: 0,
      ...
      <h3
        v-motion class="text-2xl text-subtext0" :initial=" {
          y: 100,
          opacity: 0,
        } " :enter=" {
          y: 0,
    ...
    <pre
      ...
      } " class="text-2xl font-flow flex flex-col max-w-2xl p-5 bg-mantle h-fit rounded-lg select-none"
    >
